...
echo "<title>Simple API XML Insert Backup</title>";
   ...
   function characterData($parser, $data) {
      ...
      if(!empty($data)) {
         if ($elements == 'CUSTOMER_ID' || $elements == 'CUSTOMER_NAME' || $elements == 'CUSTOMER_COUNTRY') {
   ...
   if (!($handle = fopen('http://localhost:8012/xmltry/xmlDataOfInsertBackupTbl.php', "r"))) {
   ...
   //fclose();
   //$i = 1;
   echo "<h3>Customer Insert Backup</h3>";  
   echo "<table border = '1'>";
   echo "<tr>";
